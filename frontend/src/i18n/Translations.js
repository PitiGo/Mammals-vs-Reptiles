...
const translations = {
  en: {
    ...
    gameUI: {
      ...
      ballControlInstructions: "SPACE controls the ball (max 3s). Aim at a highlighted teammate and release to pass; otherwise, shoot. Press near a rival to steal",
      sprintInstructions: "Grab items on the pitch: 💨 cyan = speed boost, 🚀 orange = homing missile at the nearest rival",
      ...
      rotateDeviceHint: "This match is designed for landscape mode so you can see more of the pitch.",
      enableLandscape: "Play in landscape",
      missileReady: "🚀 Missile armed! Press SPACE to fire it at the nearest opponent",
  ...
  es: {
    ...
    teamSelection: {
      ...
      renameBotPrompt: "Nuevo nombre del bot:",
    ...
    gameUI: {
      ...
      ballControlInstructions: "ESPACIO controla el balón (máx. 3 s). Apunta a un compañero marcado y suelta para pasar; si no, disparas. Pulsa cerca de un rival para robar",
      sprintInstructions: "Recoge ítems en la cancha: 💨 cian = velocidad, 🚀 naranja = misil teledirigido al rival más cercano",
      ...
      kickoffGo: "¡YA!",
      passAvailable: "PASE",
      rotateDeviceTitle: "Gira el móvil",
      rotateDeviceHint: "El partido está diseñado para jugar en horizontal y ver una mayor parte del campo.",
      enableLandscape: "Jugar en horizontal",
      missileReady: "🚀 ¡Misil armado! Pulsa ESPACIO para lanzarlo al rival más cercano",
